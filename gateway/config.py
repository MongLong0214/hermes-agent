...
def _parse_canonical_surface_bindings(value: Any) -> Dict[str, Any]:
    """Validate closed server-owned bindings for the dormant canonical route."""
    ...
    for raw_name, raw in value.items():
        ...
        if not isinstance(buzz, dict) or set(buzz) != {"author_ids", "channel_ids"}:
            raise ValueError("canonical source binding schema is invalid")
...
class GatewayConfig:
    ...
    # Dormant, server-owned routes to an already-existing cached gateway turn.
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        canonical_surface_bindings = _parse_canonical_surface_bindings(
            data.get("canonical_surface_bindings", nested_gateway.get("canonical_surface_bindings"))
        )
